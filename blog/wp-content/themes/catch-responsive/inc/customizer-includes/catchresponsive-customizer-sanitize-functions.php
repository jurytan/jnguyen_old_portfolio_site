 ...
 * @since Catch Responsive 1.8
 */
function catchresponsive_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function catchresponsive_sanitize_image( $image, $setting ) {
	/*
 ...
 *                    the setting default.
 */
function catchresponsive_sanitize_number_range( $number, $setting ) {
 ...
 */
function catchresponsive_sanitize_select( $input, $setting ) {
 ...
 *
 * @since Catch Responsive 1.2
 */
function catchresponsive_sanitize_important_link() {
	return false;
} 
